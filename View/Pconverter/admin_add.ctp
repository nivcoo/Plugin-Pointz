        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title"><?= $Lang->get('POINTZ__ADD_OFFER') ?></h3>
                </div>
                <div class="card-body">
                    <form action="<?= $this->Html->url(array('controller' => 'pconverter', 'action' => 'add')) ?>" method="post" data-ajax="true" data-redirect-url="<?= $this->Html->url(array('controller' => 'pconverter', 'action' => 'index', 'admin' => true)) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button data-j="1" type="button" id="addLore" class="btn btn-success"><?= $Lang->get('POINTZ__ADD_OFFER') ?></button>
                                </div>
                            </div>
